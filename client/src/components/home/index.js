        ...
        <div className="search-hero">
          ...
          <div className="search-container main-container">
            <div className="search-intro">
              <h1>@TwitterHaiku</h1>
              <p>
                Search for yourself, a friend, a trend or even just a word and
                @TwitterHaiku will find and then analyze the tweets for any
                accidental haikus!
              </p>
            </div>
            <div className="search-bar">
              ...
              <Button type="search" onClick={() => this.handleSearchSubmit()}>
                Search!
              </Button>
            </div>
          </div>
